        ...
        <div class="container-fluid contact py-5">
            <div class="container py-5">
                ...
                <div class="row g-5">
                        ...
                        <div class="row g-5">
                            <div class="col-md-6 col-lg-6 col-xl-4">
                                <div class="contact-add-item p-4">
                                    ...
                                    <div>
                                        <h4>Alamat</h4>
                                        <p class="mb-0">Jl. Diponegoro No.222, Mijen, Gedanganak, Kec. Ungaran Tim., Kabupaten Semarang, Jawa Tengah 59567</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 col-lg-6 col-xl-4 wow fadeInUp" data-wow-delay="0.3s">
                                <div class="contact-add-item p-4">
                                    ...
                                    <div>
                                        <h4>Email</h4>
                                        <p class="mb-0">suzukiindomobilsemarang@gmail.com</p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="p-5 bg-light rounded">
                            <div class="bg-white rounded p-4 mb-4">
                                ...
                                <div class="d-flex align-items-center">
                                    <p class="mb-0 text-dark me-2">Nomor Telepon:</p><i class="fa fa-phone-alt text-primary me-2"></i><p class="mb-0">0813-8082-9259</p>
                                </div>
                            </div>
                            <!-- <div class="bg-white rounded p-4 mb-4">
                    ...
                    <div class="col-12">
                        <div class="rounded">
                            <iframe class="rounded w-100"  src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15839.740005065058!2d110.4280738!3d-7.0169265!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e708d2c889adba7%3A0xcf2bee0019b2b4a3!2sSuzuki%20mobil%20semarang!5e0!3m2!1sid!2sid!4v1730453279181!5m2!1sid!2sid" height="450" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                        </div>
                    </div>
