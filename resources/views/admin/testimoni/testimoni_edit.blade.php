                            ...
                            <form method="POST" action="{{ route('testimoni.update', $testimoni->id) }}" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <input class="form-control @if(session('nama')) is-invalid @endif @error('nama') is-invalid @enderror" type="text" id="nama" name="nama" value="{{ $testimoni->nama }}" placeholder="" />
                                        @error('nama')
                                    ...
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <input class="form-control @if(session('alamat')) is-invalid @endif @error('alamat') is-invalid @enderror" type="text" id="alamat" name="alamat" value="{{ $testimoni->alamat }}" placeholder="" />
                                    ...
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <input class="form-control @if(session('bintang')) is-invalid @endif @error('bintang') is-invalid @enderror" type="text" id="onlyNumber" name="bintang" value="{{ $testimoni->bintang }}" placeholder="" />
                                        @error('bintang')
